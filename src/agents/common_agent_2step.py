...
from .prompt_utils import COT_USER_INSTRUCTION
...
class CommonAgentTwoSteps(CommonAgent):
    ...
    def _get_retryexception_message(self) -> list[tuple[str, str]] | None:
        ...
        **kwargs: Optional[Any],
        ...
        try:
            ...
            updated_prompt = self._build_prompt_for_final_step(
                system_prompt=processed_system_prompt,
                cot_msg=processed_reasoning_process,
            )
