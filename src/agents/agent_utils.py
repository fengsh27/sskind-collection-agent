...
IMPORTANT_INSTRUCTIONS_DICT = {
    ResearchGoalEnum.ALZHEIMERS: (
        ...
        "   - Check the **Methods** section for terms like \"single-cell RNA sequencing\", \"scRNA-seq\" or specific platform (e.g., 10X Genomics).\n"
        "   - See if there's a **Data Availability** section listing GEO/SRA accession codes for single-cell datasets.\n"
